...
namespace Project.App.Databases
{
    public class MongoDBContext : DbContext
    {
        ...
        public IMongoCollection<dynamic> DeviceLogs => MongoDatabase.GetCollection<dynamic>("device_logs");
        public IMongoCollection<dynamic> GroupHistory => MongoDatabase.GetCollection<dynamic>("group_histories");
    }
}
